...
public class Word_Processing_Centre extends Brain_Region {

    public Word_Processing_Centre(Neurons_ArrayList inputNeurons, int numberOfOutputs, int numberOfNeurons) {
